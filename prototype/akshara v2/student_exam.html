...
<html lang="en">
  <head>
    ...
    <link href="css/stacked_bar.css" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <div class="container">
      <div class="page_wrapper">
        ...
        <div class="row page-header">
          <div class="col-lg-3 col-sm-3">
            <h2><small>Topic: Engineering<br />Sub-Topic: Math</small></h2>
          </div>
        ...
        <div class="question_container">
          <div class="question row">
            <div class='question'>
              ...
              A point moves in the xy – plane such that the sum of its distance from two mutually perpen-
      ...
      <hr />
      <a href='#' class='btn btn-default' id="submit_exam">Submit</a>
      <a href='course_syllabus.html' class='btn btn-primary' style="display:none;" id="return_to_map">Return to Learning Map</a>
      <hr />
    </div><!-- /.container -->
