...
<div class="col-lg-6 ">
  ...
  <div class="panel">
      ...
      <div class="row">
      <div class="col-lg-2">
      <img src="images/1.jpg" alt="Shanthan Kesharaju" class="img-rounded" width="50px" height="50px">
      </div>
      <div class=col-lg-10">
      ...
      <div class=col-lg-10">
          <p><a href="student_dashboard.php?profile=profile">Shanthan Kesharaju</a> has just earned 150 points for completing the Algebra I practice exam</p>
      </div>
      <hr></hr>
      </div>
      ...
      <div class=col-lg-10">
          <p><a href="student_dashboard.php?profile=profile">Shanthan Kesharaju</a> has earned the Trigonometry Apprentice badge</p>
      </div>
      </div>
